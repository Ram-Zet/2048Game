...
public class View extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        if (isGameWon) {
            int result = JOptionPane.showConfirmDialog(this, "You've won! Once more?", "2048 game", JOptionPane.YES_NO_OPTION);
            ...
            int result = JOptionPane.showConfirmDialog(this, "You've lost! Once more?", "2048 game", JOptionPane.YES_NO_OPTION);
            if (result == JOptionPane.YES_OPTION){
                controller.resetGame();
            }
            else System.exit(0);
